...
read(Handle, Part, Offset, Length) ->
	hotchpotch_broker_io:read(Handle, Part, Offset, Length).
...
write(Handle, Part, Offset, Data) ->
	hotchpotch_broker_io:write(Handle, Part, Offset, Data).
...
set_type(Handle, Uti) ->
	hotchpotch_broker_io:set_type(Handle, Uti).
...
%%       Reason = ecode()
commit(Handle) ->
	hotchpotch_broker_io:commit(Handle).
...
%%       Reason = ecode()
suspend(Handle) ->
	hotchpotch_broker_io:suspend(Handle).
