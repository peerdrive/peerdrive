...
parse_linkmap(Body) ->
	{SDL, Body1} = parse_list_32(fun hotchpotch_netencode:parse_uuid/1, Body),
	{WDL, Body2} = parse_list_32(fun hotchpotch_netencode:parse_uuid/1, Body1),
	{SRL, Body3} = parse_list_32(fun hotchpotch_netencode:parse_uuid/1, Body2),
	{WRL, Body4} = parse_list_32(fun hotchpotch_netencode:parse_uuid/1, Body3),
